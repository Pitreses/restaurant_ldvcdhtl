...
{
    /**
     * @var \Ldvcdhtl\RestaurantLdvcdhtl\Domain\Model\Menu
     */
    ...
    {
        parent::setUp();
        $this->subject = new \Ldvcdhtl\RestaurantLdvcdhtl\Domain\Model\Menu();
    }
    ...
    {
        $entry = new \Ldvcdhtl\RestaurantLdvcdhtl\Domain\Model\Dish();
    ...
    {
        $mainDish = new \Ldvcdhtl\RestaurantLdvcdhtl\Domain\Model\Dish();
    ...
    {
        $cheese = new \Ldvcdhtl\RestaurantLdvcdhtl\Domain\Model\Dish();
    ...
    {
        $dessert = new \Ldvcdhtl\RestaurantLdvcdhtl\Domain\Model\Dish();
    ...
    {
        $drink = new \Ldvcdhtl\RestaurantLdvcdhtl\Domain\Model\Drink();
